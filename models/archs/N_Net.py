...
class FeatExtractor(nn.Module):
    def __init__(self, opt, c_in=6, c_out=128):
        ...
        self.conv1 = model_utils.conv_layer(batchNorm, c_in, 16, k=3, stride=1, pad=1)
        self.conv2 = model_utils.conv_layer(batchNorm, 16, 32, k=3, stride=2, pad=1)
        self.conv3 = model_utils.conv_layer(batchNorm, 32, 64, k=3, stride=1, pad=1)
