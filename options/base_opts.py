...
class BaseOpts(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--l_suffix", default="_mtrl.txt"
        )  # train image list suffix
        ...
        # Device Arguments ####
        self.parser.add_argument(
            "--gpu_ids", default="0", help="0,1,2,3 for gpu / -1 for cpu"
        )
        ...
        self.parser.add_argument(
            "--est_sd", default=False, action="store_true"
        )  # shading
        ...
        self.parser.add_argument(
            "--strict", default=True, action="store_false"
        )  # strict matching for checkpoint
