...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--data_dir", default="data/datasets/PS_Blobby_Dataset"
        )
        self.parser.add_argument(
            "--data_dir2", default="data/datasets/PS_Sculpture_Dataset"
        )
        self.parser.add_argument("--concat_data", default=True, action="store_false")
        self.parser.add_argument(
            "--test_h", default=128, type=int
        )  # For lighting estimation
        self.parser.add_argument("--test_w", default=128, type=int)
        self.parser.add_argument(
            "--milestones", default=[5, 10, 15], nargs="+", type=int
        )
